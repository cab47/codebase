...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 14, 2017 at 12:34 PM
...
('SK250842', 'Sushant ', '157B Street No.5 Najafgarh Delhi', 110043, 'sushant@gmail.com', 'PSA', 'Male', '1242332578', '', 'Y', '10-7PM', 'RK25012', '', ''),
...
--
-- Dumping data for table `lat_long`
--

INSERT INTO `lat_long` (`Lat`, `Longi`, `Quick_ID`, `Cluster`, `bookdate`) VALUES
(1, 2, 121, 'A', '2017-03-01'),
(2, 5, 122, 'B', '2017-03-02'),
(3, 6, 123, 'C', '2017-03-03');

-- --------------------------------------------------------

--
-- Table structure for table `unschedule`
--

CREATE TABLE `unschedule` (
  ...
  `ploc` varchar(100) DEFAULT NULL,
  `dloc` varchar(100) DEFAULT NULL,
  `reason` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `unschedule`
--

INSERT INTO `unschedule` (`bookdate`, `qid`, `mid`, `opid`, `ptime`, `ploc`, `dloc`, `reason`) VALUES
('0000-00-00 00:00:00', 'qid', 'mid', 'opid', 'ptime', 'ploc', 'dloc', 'reason'),
('', 'sk250842', 'sk250841', '', '12', 'delhi', 'haryana', 'sick'),
('', 'sk250842', 'sk250841', '', '12 am', 'delhi', 'NCR', 'sick'),
('', 'sk250842', 'sk221321', '', '12', 'delhi', 'ncr', 'sick');
